...
Route::post('/dataset', [AudioSampleController::class, 'store'])->name('dataset.store');
...
Route::post('/record/store', [RecordController::class, 'storeRecording'])->name('record.store');
